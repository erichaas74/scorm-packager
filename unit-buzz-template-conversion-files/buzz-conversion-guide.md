...
| U2 Honors | Coriolis Cannon Challenge | Buzz-native, self-contained 2D simulation; standalone full-globe practice | 8 q / 15 pts (6 MC, 2 BusyBee E) | Converted. Trial evidence persists in the browser tab; no upload or SCORM score is used. Upload `u2h-coriolis-cannon-buzz-assessment-template.html`; keep question randomization and one-question-per-page off. |
