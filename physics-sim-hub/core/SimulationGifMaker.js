...
import { patchC2SContext as patchC2SContextShared } from './canvasSvgUtils.js';
...
export default class SimulationGifMaker {
    ...
    playPreview() {
        this.playSegment(0, Math.max(0.01, this.getPlaybackDuration()));
    }
    ...
    async exportSvg() {
        ...
        try {
            ...
            patchC2SContextShared(svgContext);
